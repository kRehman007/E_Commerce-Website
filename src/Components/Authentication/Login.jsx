...
const Authentication = () => {
  ...
  return (
        ...
        {!first ? (
          <>
            <div>
              ...
              <p className="text-sm pt-1">Enter your details below</p>{" "}
            </div>
    ...
    placeholder-slate-400 text-sm w-[100%]"
              ...
              <button
                type="submit"
                className="bg-red-700 w-full py-1 text-white rounded-md"
              >
                {loading ? <Spinner /> : "Create Account"}
              </button>
              <button
                className="bg-none px-3 py-1 w-full mt-2 flex space-x-2 justify-center items-center"
            ...
            <div className="flex space-x-2 justify-center items-center">
              ...
              <NavLink
                className="underline font-semibold text-red-800 text-sm"
    ...
    placeholder-slate-400 text-sm w-[100%]"
              ...
              <button
                type="submit"
                className="bg-red-700 w-[max-content] px-4 py-2 text-white rounded-md"
              >
              ...
              <div className="flex items-center space-x-2 test-sm justify-center mt-3 mr-9 lg:mr-16">
                ...
                <NavLink
                  className="text-red-800 font-semibold ml-1 underline"
                  style={{ textUnderlineOffset: "6px" }}
                  onClick={() => handle()}
                >
                  Sign up
            ...
            {Singerror && (
              <p className="text-red-900 text-sm">{Singerror.message}</p>
            )}
          </>
        )}
      </div>
