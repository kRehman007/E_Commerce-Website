...
const Footer = () => {
  return (
    <div className='bg-black w-full mt-16   pl-11 pt-16  pb-16 pr-11'>
      <div className=' flex flex-col lg:justify-center space-y-16  md:grid 
      md:grid-cols-2 md:gap-7 lg:flex lg:flex-row lg:space-x-7 lg:space-y-0
       '>
      <div className='mr-8 md:mt-16 lg:mt-0'>
    <h1 className='text-white font-bold text-2xl'>Exclusive</h1><br />
    <h3 className='text-white text-xl'>Subscribe</h3><br />
    ...
    <input type='email' autoSave='false' autoComplete='false' placeholder='Enter your email' className='bg-transparent outline-none
    placeholder-gray-400 text-white' />
    <p className='text-2xl text-white'><PiTelegramLogo /></p>  
    </div>
    </div>
    ...
    <p className='mt-3 lg:mt-0 lg:ml-5'><FaFacebookSquare /></p>
    <p><FaTwitterSquare /></p>
