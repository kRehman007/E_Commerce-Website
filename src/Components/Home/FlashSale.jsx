  ...
  return (
    <>
      <div className=" flex flex-col space-y-3 justify-center p-3  md:ml-16 mt-11">
        <div className="flex space-x-1 rounded-sm items-center pl-1">
          <div className="w-3 h-[30px] bg-red-600 border-none"></div>
          <span className="text-sm text-red-600 font-semibold ">Today's</span>
        </div>
        ...
        <button
          className="px-3 py-1 bg-red-600 w-[max-content] m-auto mt-5 
    text-white"
            ...
            <div key={index}>
              <Card className="w-[150px] h-[200px] md:w-[260px] md:h-[300px]">
                <Card.Img
                  variant="top"
                  src={item.img}
                  className="h-[100px] md:h-[200px] object-cover p-1"
                  onClick={() => handleModal(item)}
                />
                <Card.Body
                ...
                >
                  <Card.Title className="text-sm mb-0 md:text-xl font-medium  md:font-semibold">
                    {item.name}
                  </Card.Title>
                  <Card.Text
                    style={{
...
export const NewArrival = () => {
  return (
    <div
      className=" flex flex-col space-y-1 ml-4 md:mr-4 md:ml-16  md:mt-0 mb-6
    overflow-hidden"
    >
      <div className="flex space-x-1 rounded-sm items-center">
        <div className="w-3 h-[30px] bg-red-600 border-none"></div>
        <span className="text-sm text-red-600 font-semibold">Featured</span>
      </div>
      <p className="font-bold text-3xl">New Arrival</p>
      <div
        className=" flex flex-col lg:grid lg:grid-cols-2 gap-3  lg:ml-0 pt-4 md:pt-10 overflow-hidden
 w-[96%] lg:w-[98%] "
      >
        <div className="h-[402px]">
          <div className="bg-black h-[100%] relative overflow-hidden">
            <img src={NA1} className="h-[100%] float-right" />
        ...
        <div className="flex flex-col space-y-2 h-[402px]">
          <div className="bg-black h-[50%] relative overflow-hidden">
            <img src={NA2} className="h-[100%] float-right" />
            ...
            <div className="absolute bottom-6 md:bottom-8 pl-8  flex flex-col space-y-2">
              ...
              <p className="text-sm text-white">
                Featured man collection that
                <br />
                give you another vibe
              </p>
              <NavLink to="" className="text-white font-medium underline ">
                Shop Now
              </NavLink>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3 h-[50%] overflow-hidden">
            <div className="bg-black relative">
              <img src={NA3} className="h-[100%] float-right object-cover" />
  ...
  const Array = [
    {
      ...
      msg: "Free delivery for all orders over $140",
    },
    {
      icon: <RiCustomerService2Line />,
      text: "24/7 CUSTOMER SERVICE",
      msg: "Friendly 24/7 customer support",
    },
    {
      icon: <IoShieldCheckmarkOutline />,
      text: "MONEY BACK GUARANTEE",
      msg: "We return money within 30 days",
    },
  ];
  return (
    <div
      className="grid grid-cols-1  lg:grid-cols-3 gap-4 mt-8 pt-16 lg:pt-8 md:mt-20  w-[70%]
  relative left-[50%] translate-x-[-50%] "
    >
      {Array.map((item, index) => (
        ...
        >
          <div
            className="w-[60px] h-[60px] flex items-center justify-center border border-black
