...
const Home = () => {
  ...
  return (
        <>
    <div className='w-[90%] relative left-[50%] translate-x-[-50%]  lg:h-[min-content] 
      flex space-x-4  justify-center pt-5'>
    <ul 
     className='text-black hidden lg:block whitespace-nowrap border-r-2 pr-16'> 
     <li className='pt-3'><NavLink to='/WomenFashion'>Woman's Fashion</NavLink></li>
     <li><NavLink to='/MenFashion'>Man's Fashion</NavLink></li>
     ...
     <li><NavLink to='/Baby'>Baby's & Toys</NavLink></li>
     <li><NavLink to='/Groceries'>Groceries & Beauty</NavLink></li>  
    </ul>
  ...
  >
      {data?.slice(15,20).map((res,index)=>(
        ...
        <img src={res.img}  className='w-[100%] h-[100%]' /></div>
      </SwiperSlide>
