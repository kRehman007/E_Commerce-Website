...
const WomenFashion = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Women"))
      );
    };
    getData();
  }, []);
...
export const MenFashion = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Men"))
      );
    };
    getData();
  }, []);
...
export const Medicine = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Medicine"))
      );
    };
    getData();
  }, []);
...
export const Sports = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Sports"))
      );
    };
    getData();
  }, []);
...
export const Baby = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Toys"))
      );
    };
    getData();
  }, []);
...
export const Groceries = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      const FlashData = await GetDocumentData();
      setData(
        FlashData?.images.filter((item) => item.category.includes("Grocery"))
      );
    };
    getData();
  }, []);
