...
const Computer = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Computer"))
      );
    };
    getData();
  }, []);
...
export const Phone = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Mobile"))
      );
    };
    getData();
  }, []);
...
export const SmartWatch = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("SmartWatch"))
      );
    };
    getData();
  }, []);
...
export const HeadPhone = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("HeadPhone"))
      );
    };
    getData();
  }, []);
...
export const Camera = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      const FlashData = await GetDocumentData();
      setData(
        FlashData?.images.filter((item) => item.category.includes("Camera"))
      );
    };
    getData();
  }, []);
...
export const Gaming = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Game"))
      );
    };
    getData();
  }, []);
...
export const PlayingStation = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Playing"))
      );
    };
    getData();
  }, []);
...
export const Perfume = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setData(
        FlashData?.images.filter((item) => item.category.includes("Perfume"))
      );
    };
    getData();
  }, []);
