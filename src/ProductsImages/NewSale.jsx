...
const handleModal=(item)=>{
  ...
  return (
    ...
    {data?.slice(20,40).map((item,index)=>(
    <div  key={index} className='flex flex-col items-start'>
    <Card className='w-[150px]  min-h-[200px] md:w-[260px] md:min-h-[300px]' >
      <Card.Img variant="top" src={item.img || item.src} className='h-[100px] md:h-[200px] object-cover
      cursor-pointer'
...
<CustomModal isOpen={isOpen} onClose={onClose} id={ItemList.id} price={ItemList.price} title={ItemList?.name}
