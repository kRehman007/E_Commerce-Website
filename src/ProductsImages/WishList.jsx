    ...
    <>
      {WishItem?.length === 0 ? (
        <div className="flex flex-col items-center justify-center mt-10  text-red-500">
          ...
          <button
            onClick={() => navigate("/")}
            className="px-3 py-2 bg-red-700 text-white text-md mt-4 border border-gray-200"
          >
            Return to Home
          </button>
        </div>
        ...
        <>
          <div className="flex justify-between items-center mb-16 mt-24 w-[90vw] relative left-[50%] translate-x-[-50%]">
            ...
            <button
              ...
              className="px-3 py-2 bg-red-700 text-white text-md border border-gray-200"
            >
              Return to Home
            </button>
          </div>
              ...
              <div key={index}>
                <Card className="w-[160px] h-[300px] md:w-[330px] md:h-[380px]">
                  <Card.Img
                    variant="top"
                    src={item.img}
                    className="min-h-[150px] md:h-[200px] object-cover p-1"
                  ...
                  >
                    ...
                    <div
                      className="text-2xl md:text-3xl cursor-pointer text-white absolute top-5 right-5"
                  ...
                  <button
                    className="bg-red-500 text-md w-ful text-white
   py-2"
              ...
              <div key={index}>
                <Card className="w-[160px] h-[300px] md:w-[330px] md:h-[380px]">
                  <Card.Img
                    variant="top"
                    src={item.img}
                    className="h-[150px] md:h-[200px] object-cover p-1"
                    onClick={() => handleModal(item)}
                  />
                  <Card.Body
                    className="pt-2 md:pt-4"
