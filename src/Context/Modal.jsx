...
<ModalContent w="80vw">
 ...
 <div className='flex flex-col space-y-1 space-x-0 md:flex-row md:space-x-1 md:space-y-0
        rounded-sm mt-4'>
     <button className='bg-red-400 h-[min-content] px-3 py-2'
     onClick={()=>hanldeCart(id,title,qty,img,price)}>Add to Cart</button>
     <button className='bg-green-400 px-3 py-2 text-white mb-3'
     onClick={()=>handleBuyNow(id,title,qty,img,price)}>Buy Now</button></div>
  </ModalBody>
</ModalContent>
</Modal>
  );
